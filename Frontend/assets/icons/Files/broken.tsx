...
export const Folder2: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
		...
		>
			...
			/>
			<path
				d="M22 14.9883V16.9983C22 20.9983 21 21.9983 17 21.9983H7C3 21.9983 2 20.9983 2 16.9983"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeMiterlimit="10"
				strokeLinecap="round"
...
export const FolderAdd: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const FolderCloud: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
		...
		>
			...
			/>
			<path
				d="M9 22.0013H7C3 22.0013 2 21.0013 2 17.0013V12.0312"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeMiterlimit="10"
				strokeLinecap="round"
			...
			/>
			<path
				d="M13.7586 18.3204C11.4086 18.4904 11.4086 21.8904 13.7586 22.0604H19.3186C19.9886 22.0604 20.6486 21.8104 21.1386 21.3604C22.7886 19.9204 21.9086 17.0404 19.7386 16.7704C18.9586 12.0804 12.1786 13.8604 13.7786 18.3304"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeMiterlimit="10"
				strokeLinecap="round"
...
export const FolderCross: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
		...
		>
			<path
				d="M13.8095 15.7314L10.2695 12.1914"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeMiterlimit="10"
				strokeLinecap="round"
...
export const FolderFavorite: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const FolderMinus: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
