...
export const Bank: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const Building3: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const Building4: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
		...
		>
			...
			/>
			<path
				d="M19.7996 10.8906C18.5796 10.8906 17.5996 11.8706 17.5996 13.0906V15.3606C17.5996 16.5806 18.5796 17.5606 19.7996 17.5606C21.0196 17.5606 21.9996 16.5806 21.9996 15.3606V13.0906C21.9996 11.8706 21.0196 10.8906 19.7996 10.8906Z"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeMiterlimit="10"
				strokeLinecap="round"
			...
			/>
			<path
				d="M2.09961 22.0017V6.03174C2.09961 4.02174 3.09966 3.01172 5.08966 3.01172H11.3196C13.3096 3.01172 14.2996 4.02174 14.2996 6.03174V22.0017"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeMiterlimit="10"
				strokeLinecap="round"
...
export const Building: React.FC<IconProps> = ({ ...props }) => {
	return (
		...
		>
			<path
				d="M12.4987 22.0003H4.07875C2.91875 22.0003 1.96875 21.0703 1.96875 19.9303V5.09035C1.96875 2.47035 3.91875 1.28035 6.30875 2.45035L10.7487 4.63035C11.7087 5.10035 12.4987 6.35035 12.4987 7.41035V22.0003Z"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeLinecap="round"
				strokeLinejoin="round"
			/>
			<path
				d="M21.97 15.0619V18.8419C21.97 21.0019 20.97 22.0019 18.81 22.0019H12.5V10.4219L12.97 10.5219L17.47 11.5319L19.5 11.9819C20.82 12.2719 21.9 12.9519 21.96 14.8719C21.97 14.9319 21.97 14.9919 21.97 15.0619Z"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeLinecap="round"
				strokeLinejoin="round"
			...
			/>
			<path
				d="M17.4687 11.5295V14.7495C17.4687 15.9895 16.4588 16.9995 15.2188 16.9995C13.9787 16.9995 12.9688 15.9895 12.9688 14.7495V10.5195L17.4687 11.5295Z"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeLinecap="round"
				strokeLinejoin="round"
			/>
			<path
				d="M21.9587 14.8713C21.8987 16.0513 20.9188 17.0013 19.7188 17.0013C18.4787 17.0013 17.4688 15.9913 17.4688 14.7513V11.5312L19.4988 11.9812C20.8188 12.2712 21.8987 12.9513 21.9587 14.8713Z"
				stroke="#292D32"
				strokeWidth="1.5"
				strokeLinecap="round"
				strokeLinejoin="round"
...
export const Buildings2: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const Buliding: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const Courthouse: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
...
export const House2: React.FC<IconProps> = ({ ...props }) => {
	return (
		<svg
			{...props}
			width="24"
